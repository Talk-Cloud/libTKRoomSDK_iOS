...
Pod::Spec.new do |s|
 ...
 #                  DESC
  ...
  s.homepage     = "https://github.com/Talk-Cloud/libTKRoomSDK_iOS"
  ...
  s.source       = { :git => "https://github.com/talk-cloud/libTKRoomSDK_iOS.git", :tag => "v#{s.version}" }
  ...
  s.vendored_frameworks = 'libsdk/iphoneos(真机)/libTKRoomSDK.framework' #,'sdk/SocketIO.framework','sdk/Starscream.framework'
